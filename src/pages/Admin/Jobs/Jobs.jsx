              ...
              <table className="w-full text-left" id="myTable">
                <thead className="border-b">
                  <tr>
                    ...
                    <th className="p-3 flex gap-4 items-center">
                      <span>Name</span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                ...
                <tbody>
                  <tr className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-3">arrafi2502@gmail.com</td>
                    <td className="p-3">Project 1</td>
                    <td className="p-3 text-center">
                      <a href="" className="px-2 inline-block" title="detail">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
                          stroke="currentColor"
                          className="w-5 h-5 stroke-main hover:stroke-blue-700"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      <a href="" className="px-2 inline-block">
                        <svg
                          ...
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
                          className="w-5 h-5 stroke-secondary hover:stroke-yellow-600"
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      <button
                        type="button"
                        className="btn-delete px-2 inline-block"
                        data-id=""
                        data-action=""
                      >
                        <svg
